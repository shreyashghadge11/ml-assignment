...
def run_experiment_cifar10(out_fpath=None, experiment_args=None, seed=0,flag=0):
...
if __name__ == '__main__':
    ...
    out_fpath = '/outputs/'
    run_experiment_cifar10(out_fpath=out_fpath, experiment_args=args, seed=seed,flag=0)
